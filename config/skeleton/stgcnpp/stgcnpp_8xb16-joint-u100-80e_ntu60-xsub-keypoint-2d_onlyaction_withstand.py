...
excluded_labels = ['B05','B07','B08','B09','B11','B12']
active_labels = [f'B{i:02d}' for i in range(1, 14) if f'B{i:02d}' not in excluded_labels]
...
ann_file = 'data/presentation_data_onlyaction_withstand.pkl'
